      ...
      <div className="container">
        <div style={{
          ...
          <div>
            ...
            <a href="/download" className="btn btn-outline" style={{ padding: '10px 20px', fontSize: 13, width: '100%', justifyContent: 'center', textDecoration: 'none' }}>
            ...
            <a href="/download" className="btn btn-outline" style={{ padding: '10px 20px', fontSize: 13, width: '100%', justifyContent: 'center', marginTop: 8, textDecoration: 'none' }}>
